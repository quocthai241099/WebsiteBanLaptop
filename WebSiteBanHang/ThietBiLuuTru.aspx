<%@ Page Title="" Language="C#" MasterPageFile="~/TrangChinh.master" AutoEventWireup="true" CodeFile="ThietBiLuuTru.aspx.cs" Inherits="ThietBiLuuTru" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <asp:DataList ID="DataList1" runat="server" CellPadding="10" CellSpacing="10" DataSourceID="SqlDataSource1" RepeatColumns="4">
        <ItemTemplate>
            <asp:Image ID="Image1" runat="server" ImageUrl='<%# "Image/"+Eval("HINHANH") %>' />
<br />
            <asp:Label ID="Label4" runat="server" Font-Bold="True" ForeColor="#993300" Text='<%# Eval("DONGIA")+" VNĐ" %>'></asp:Label>
<br />
